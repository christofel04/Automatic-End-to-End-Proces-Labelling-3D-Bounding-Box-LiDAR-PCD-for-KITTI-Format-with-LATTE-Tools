...
def _build_dtype(metadata):
    ...
    *TODO* allow 'proper' multi-count fields.
    ...
    print( "Field Names are : " + str( fieldnames ) )
    print( "Type Names are : " + str( typenames ))
    #print( "Field Names and Type Names are : " + str( zip(fieldnames, typenames) ))
    #dtype = np.dtype(zip(fieldnames, typenames) )
    dtype = np.dtype( [ ( fieldnames[ i ] , typenames[ i ] ) for i in range( len( fieldnames ) ) ] )
    print( "Field Names and Type Names are : " + str( dtype ))
    return dtype
